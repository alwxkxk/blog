...
<img alt="hash table" src="https://media.githubusercontent.com/media/alwxkxk/blog/gh-pages/blog_images/hash-table.png" style="width:50%;">

&emsp;不同数值经哈希函数得到相同的键值时，称为碰撞（collision）问题，有两种解决方案：
- 单独连接（separate chaining），使用链表。
<img alt="hash table" src="https://media.githubusercontent.com/media/alwxkxk/blog/gh-pages/blog_images/separate-chaining.png" style="width:50%;">
