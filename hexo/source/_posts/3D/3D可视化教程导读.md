...
4. 了解3D的各种原理，极力推荐书籍：[《交互式计算机图形学——基于WebGL的自顶向下方法》](https://m.tb.cn/h.VOKMjHt),及网上教程[webglfundamentals](https://webglfundamentals.org/)


<img alt="交互式计算机图形学" src="/blog_images/3d/交互式计算机图形学.png" onclick="window.open('https://m.tb.cn/h.VOKMjHt')" style="cursor:pointer;width:50%;">
