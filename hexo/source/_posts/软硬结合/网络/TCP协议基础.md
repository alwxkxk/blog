...
![TCP数据封装在IP数据中](https://media.githubusercontent.com/media/alwxkxk/blog/gh-pages/blog_images/005BIQVbgy1fwdr99chz2j30ru060glj.jpg)
&emsp;我们从上一节IP协议基础知道，TCP数据是会封装到IP数据当中，我们现在看看TCP协议的头部数据定义：
![TCP头部](https://media.githubusercontent.com/media/alwxkxk/blog/gh-pages/blog_images/005BIQVbgy1fwdrcbdccjj30sg0lcwfs.jpg)
...
## wireshark 分析TCP通信
&emsp;安装[wireshark-百度网盘](https://pan.baidu.com/s/17TVX8fxuVopEGAo6sf90Lg)，并开启window网卡的抓包服务（否则找不到对应的网卡），进行抓包。之前我们在本机使用两个网络调试助手进行TCP通信，是属于回环数据（可以理解为数据并没有经过真实的网卡流出去，一直在本机里互传），抓包比较麻烦。我在服务器用nodejs写了一个简单的TCP服务器端（42.192.168.165:9001，[源码-nodejs基础-#搭建最简TCP服务器](/blog/posts/56793/#搭建最简TCP服务器)），使用网络调试助手开启客户端进行连接并发送数据，并使用wireshark抓包进行分析。
&emsp;开启windows抓包服务：
```bash
#以管理员方式运行 cmd.exe
net start npf
...
![wireshark抓包图](https://media.githubusercontent.com/media/alwxkxk/blog/gh-pages/blog_images/005BIQVbgy1fwfkehuv4lj31020nxgon.jpg)
...
![wireshark-1](https://media.githubusercontent.com/media/alwxkxk/blog/gh-pages/blog_images/005BIQVbgy1fwfv8bhxxdj31060nwtav.jpg)
![wireshark-2](https://media.githubusercontent.com/media/alwxkxk/blog/gh-pages/blog_images/005BIQVbgy1fwfv96r0ilj31060nwace.jpg)
![wireshark-3](https://media.githubusercontent.com/media/alwxkxk/blog/gh-pages/blog_images/005BIQVbgy1fwfv9h0k85j31060nwmzj.jpg)
...
![tcp-1](https://media.githubusercontent.com/media/alwxkxk/blog/gh-pages/blog_images/005BIQVbgy1fwfvcp6nakj31060nwacu.jpg)
