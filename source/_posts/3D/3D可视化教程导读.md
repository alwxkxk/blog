...
## 教程状态与作者水平
&emsp; 教程状态：正处于制作阶段，利用业余时间探索，不断添加内容。
&emsp; 作者水平：有一定的three.js使用经验，独自探索学习使用，太底层太高深的不懂，但足于应付“智慧城市”，“智慧XXX”这些项目的3D可视化。


&emsp; 以前在公司的作品：
![微模块](/blog/blog_images/微模块1.gif)
![微模块](/blog/blog_images/微模块2.gif)

&emsp; 19年为了找工作，新做了一个项目以作展示：[iot-visualization-examples](https://github.com/alwxkxk/iot-visualization-examples)：
![iot-visualizaiton-datacenter](/blog/blog_images/iot-visualizaiton-datacenter.webp)
...
&emsp; 换了新公司后，进一步学习Blender建模软件自行建模（在以前的公司有专门的美工做模型，新公司没有只能自己来了），做的页面也蛮好看的，但这些暂时不能放上展示。

## 要求读者水平
- 有基础的HTML、CSS、JavaScript编码功能，并且会调试。（所以这些前端基础知识我不会再讲。）
- 为不受其它框架影响代码，免去读者花时间额外了解其它框架，就单纯用最简单的方式来手写。（所以没有用Vue，React这些玩意。）

![小白不要学3D可视化](/blog/blog_images/3d/小白不要学3D可视化.webp)
