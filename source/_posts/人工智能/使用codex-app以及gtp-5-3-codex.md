...
&emsp;后续看到codex-app出来，以及到处传各种codex免费，L站大量codex公益(我使用的是[GBOOM公益](https://ai.qaq.al/))，我就尝试了一下,发现确实好用。
...
## 更新
- 26年4月开始已经不能用了，codex免费的资源比较动荡，经常需要换公益站。

## 附录
- [GGBOOM 公益站的食用说明](https://linux.do/t/topic/1563294)
