...
## 结论放前面
&emsp;__开发效率提升20%以上，精力节省30%以上，上班写代码没那么累了。__ 网上还有一个评价十分到位：__AI能替你快速试错踩坑__。而我们部门领导的评价是：人工智能让我们每个人都能轻松获取其它行业的中低级工程师水平的知识，不再需要通过人脉去找行业的人进行交流。__要求团队全面拥抱AI。__ AI在以下场景十分好用：

1. 给出表结构与需求，让AI生成SQL语句。
2. 让AI生成正则表达式。
3. 让AI生成常见软件的配置(如nginx)。
4. 让AI重构代码，抽取重复代码变成函数。
5. 指定函数的输入与输出，让AI生成代码。（限定一个函数范围，ai就很好使。）
6. 个人的想法的小项目，没有AI的时候，一般都是懒得写，投入产出比不高。现在有AI，基本上很多想法都可以让AI来帮我实现，我只需要指挥就行。（这两个月来，我已经让AI完成了一个三维模型格式性能对比工具，三维场景图片去重性能对比工具，来给我的论文提供可量化的测试数据。）
